    ...
    <div class="row gallery-row"><!-- Begin Gallery Row --> 
    	...
    	<div class="span12">
            <h5 class="title-bg">Популярные статьи 
                ...
                <button class="btn btn-mini btn-inverse hidden-phone" type="button">Все статьи</button>
            </h5>
        ...
        ================================================== -->
            ...
            <ul class="gallery-post-grid holder">
                    ...
                    <li  class="span3 gallery-item" data-id="id-1" data-type="illustration">
                        ...
                        <a href="open_ip.php"><img src="img/slider/1.jpg" alt="Gallery"></a>
                        <span class="project-details"><a href="gallery-single.htm">Сколько стоит открыть ИП?</a>Многие предприниматели, решившие открыть собственное дело, задаются вопросом: «Во сколько это обойдется?»</span>
                    </li>
...
<!--                                 <a href="img/gallery/gallery-img-1-full.jpg" class="item-zoom-link lightbox" title="Custom Illustration" data-rel="prettyPhoto"></a>
 -->                                <a href="gallery-single.htm" class="item-details-link"></a>
                        ...
                        <a href="gallery-single.htm"><img src="img/slider/1.jpg" alt="Gallery"></a>
                        <span class="project-details"><a href="gallery-single.htm">Как подобрать виды деятельности для ИП</a>При государственной регистрации будущей предприниматель должен заявить, чем именно он планирует заниматься.</span>
                    </li>
                    ...
                    <li class="span3 gallery-item" data-id="id-3" data-type="web">
                        ...
                        <a href="gallery-single.htm"><img src="img/slider/1.jpg" alt="Gallery"></a>
                        <span class="project-details"><a href="gallery-single.htm">Как открыть ИП по временной регистрации</a>Право вести предпринимательскую деятельность в России есть у любого совершеннолетнего гражданина, а также иностранца.</span>
                    </li>
                    ...
                    <li class="span3 gallery-item" data-id="id-4" data-type="video">
                        ...
                        <a href="gallery-single.htm"><img src="img/slider/1.jpg" alt="Gallery"></a>
                        <span class="project-details"><a href="gallery-single.htm">Может ли иностранец открыть ИП в России</a>Большинство стран позволяет вести бизнес на своей территории не только собственным гражданам, но и иностранцам.</span>
                    </li>
    ...
    <div class="row"><!-- Begin Bottom Section -->
        ...
        <div id="blogCarousel" class="carousel slide ">
            ...
            <div class="carousel-inner">
                ...
                <div class="active item">
                    <a href="blog-single.htm"><img src="img/slider/1.jpg" alt="" class="align-left blog-thumb-preview" /></a>
                    ...
                    <p class="blog-summary">Многие бизнесмены, взявшие «пандемийные» кредиты, в апреле 2021 года получили из банков сообщения о списании всех сумм, поскольку сохранили свой штат. <a href="#">Читать далее</a><p>
                </div>
        ...
        <div class="span6">
            ...
            <div class="carousel-inner">
                ...
                <div class="active item">
                    <p class="quote-text">"Что вы должны сделать — так это создать великолепный продукт или сервис с целью изменить мир. Если вы сделаете это, вы можете стать легендой. — Гай Кавасаки"</cite></p>
                </div>
            ...
            <!--     <div class="span3 footer-col">
                ...
                <div class="span3 footer-col">
                    <h5>Последние новости</h5>
                     <ul class="post-list">
                        <li><a href="nevoz_kred.php">Некоторым компаниям приходится платить за невозвратные кредиты</a></li>
                        <li><a href="obn_por.php">Обновился порядок внесения изменений в реестры юрлиц и ИП</a></li>
                        <li><a href="ip_bez_rabot.php">Для ИП без работников могут вернуть вычет на ККТ</a></li>
                        <li><a href="egril.php">ФНС снова чистит ЕГРЮЛ: кому стоит опасаться</a></li>

...
<center>
   ...
   <a href="ifns_codes.php"> <h4><u>Список кодов ОКВЭД и ИФНС</u></h4></a>
    <div class="row">
...
<p>
    ...
    <input name="password" type="password" size="15" maxlength="15" value="<?php echo "$row4[0]"; ?>">
    </p>
    <p>
...
?>
<select name="code" id="loads" style="width: 900px;">
...
$result11 = mysqli_query($link,"SELECT Number FROM ifns WHERE Adress = '$row[2]'");
  ...
  $row11= mysqli_fetch_array($result11);
       ...
       ?>
        <select name="ifns" id="ifns" style="width: 900px;">
